...
class UIManager {
    ...
    initElements() {
        ...
        this.rewinderValue = document.getElementById('rewinder-value');
        this.rewinderWarning = document.getElementById('rewinder-warning');
    }
    ...
    update() {
        ...
        if (this.rewinderValue) {
            this.rewinderValue.textContent = Math.max(0, Math.ceil(this.game.state.rewinderTime));
        }
        if (this.rewinderWarning) {
            const warningActive = this.game.state.rewinderTime > 0 && this.game.state.rewinderTime <= 5;
            this.rewinderWarning.classList.toggle('active', warningActive);
        }
    ...
    updateViewPosition(viewPosition) {
        ...
        if (this.game.updateCrankPosition) {
            this.game.updateCrankPosition(viewPosition);
        }
    }
}
