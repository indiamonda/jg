function createUnityInstance(e, r, n) {
    ...
    function o(e) {
        ...
        if (t.startsWith(n) && (t = t.substring(n.length)), n += "\n" + t.trim(), n && c.stackTraceRegExp && c.stackTraceRegExp.test(n)) {
                ...
                if ("undefined" == typeof unityFramework || !unityFramework) {
                    ...
                    for (var o in r) {
                        ...
                        if (c.frameworkUrl.endsWith("." + a[0])) {
                            ...
                            if ("file:" == location.protocol) return void t(i + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error");
    ...
    h.forEach(function(r) {
        ...
        c.disableAccessToMediaDevices(), h.forEach(function(r) {
    ...
    return c.SystemInfo = function() {
        ...
        function r(r, n) {
            var t = function() {};
            return n && n.onProgress && (t = n.onProgress), fetch(r, n).then(function(r) {
                function n() {
                    return "undefined" == typeof a ? r.arrayBuffer().then(function(e) {
                        ...
                        return e.done ? o() : (u + e.value.length <= l.length ? (l.set(e.value, u), c = u + e.value.length) : d.push(e.value), u += e.value.length, t({
                            type: "progress",
                            total: Math.max(s, u),
                            loaded: u,
                            lengthComputable: i
                ...
                function o() {
                    ...
                    e.set(l, 0);
                    for (var r = c, n = 0; n < d.length; ++n) e.set(d[n], r), r += d[n].length;
                    return e
                }
                var a = "undefined" != typeof r.body ? r.body.getReader() : void 0,
                    ...
                    u = 0,
                    c = 0;
                return i || console.warn("[UnityCache] Response is served without Content-Length header. Please reconfigure server to include valid Content-Length for better download performance."), n().then(function(e) {
                    return t({
                        type: "load",
                        total: e.length,
                        loaded: e.length,
